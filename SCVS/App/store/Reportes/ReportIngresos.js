...
Ext.define('SCVS.store.Reportes.ReportIngresos', {
    extend: 'Ext.data.Store',
    model: 'SCVS.model.Reportes.ReportIngresos', //Llamamos el Modelo Antes Creado
    autoSync: true, //Sincronizacion con el Servidor			
    
    proxy: {
        type: 'ajax',
        api: {//Declaramos la API y Comienzan en estas lineas las operaciones CRUD
            read: BASE_URL + 'CReportes/ext_get_total_ingresos'
