...
Ext.define('SCVS.view.InventarioVent.PanelInventarioVent', {
    extend: 'Ext.Panel',
    alias:'widget.panelGrdInventarioVent',
    closable: false,
    autoScroll: true,
    closable: false,
            layout: 'hbox',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                ...
                }, Ext.create('SCVS.view.InventarioVent.GrdInventarioVent')
            ]
        });
        this.callParent();
    }
