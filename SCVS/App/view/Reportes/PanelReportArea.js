...
Ext.define('SCVS.view.Reportes.PanelReportArea', {
    extend: 'Ext.Panel',
    alias:'widget.panelGrdReportArea',
    closable: false,  	
    layout:'fit',
	autoScroll: true,
    closable: false,
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                                        ...
                                        listeners: {
                                            specialkey: function (field, e) {
                                                ...
                                                if (e.getKey() == e.ENTER) {
                                                    ...
                                                    form.queryById('BtnSearchArea').focus();
                                                }
                                            }
                                        }
                                     },{
                ...
                }, Ext.create('SCVS.view.Reportes.GrdReportArea')
            ]
        });
        this.callParent();
    }
