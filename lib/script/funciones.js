...
$(document).ready(function () {
    ...
    $(".editar_button").on('click', function () {

        var id = $(this).attr('id_ent');
        var nombre = $("#nombre" + id).html();
        var apellidos = $("#apellidos" + id).html();

        $("<div class='edit_modal'><form name='edit' id='edit' method='post' action=''>"+
            ...
            "<label>Apellidos</label><input type='text' name='apellidos'  value="+apellidos+" id='apellidos' /><br/>"+
                        ...
                        $.ajax({
                            ...
                            success:function (data) {
                                ...
                                if(obj.respuesta == 'error')
                                {
                                        ...
                                        $(".respuesta").html(obj.nombre + '<br />' + obj.apellidos);
                                        return false;
